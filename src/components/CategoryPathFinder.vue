        ...
        <div class="space-y-4">
          ...
          <div class="mt-6">
            ...
            <div class="bg-gray-100 p-4 rounded-md">
              <pre class="text-sm text-gray-700 overflow-x-auto">{{ JSON.stringify(categories, null, 2) }}</pre>
            </div>
          </div>
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        <div class="text-gray-600" data-testid="dialog-message">
          <pre class="whitespace-pre-wrap font-mono text-sm bg-gray-100 p-3 rounded">{{ dialogMessage }}</pre>
        </div>
...
import type { Category, TestCase, TestResult, CategoryPath } from '../../types/category'
